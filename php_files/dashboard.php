        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="approved_response.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Responses</a>
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="d-flex align-items-center ms-4 mb-4 nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <div class="position-relative">
                                <img class="rounded-circle" src="../template/img/<?php echo $call["avatar"] ?? 'user.jpg'; ?>" alt="" style="width: 40px; height: 40px;">
                                <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                            </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="approved_response.php">Show All</a>
                    </div>
